 ...
 * @author Skot
 */
public class OgreUnit extends ogre.Unit
{
    ...
    public OgreUnit(int mark)
    {
        ...
        switch (mark)
        {
            //Mark III OgreUnit: 1 main, 4 secondary, 8 ap, 2 missiles, 45 treads, 15 per row
            case 3:
            default:
    ...
    //Returns the OgreUnit's current movement allowance based on its remaining treads
    public int getCurrentMovement()
    {
        movement =  (maxMovement - (treads.getLostOverRow()));
        return movement;
    }
